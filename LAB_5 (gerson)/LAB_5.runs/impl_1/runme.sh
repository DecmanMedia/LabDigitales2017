...
HD_PWD='C:/Users/Gerson/Documents/ELO212/LAB_5/LAB_5/LAB_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_modulept2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_modulept2.tcl -notrace
