...
HD_PWD='C:/GitHub/LabDigitales2017/Lab6_Prev_Preg4/Lab6_Prev_Preg4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KB_to_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KB_to_display.tcl
