...
HD_PWD='C:/Users/Diego/LabDigitales2017/Lab6_PartePrevia_VGA/Lab6_PartePrevia_VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_pattern_previo_640x480.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_pattern_previo_640x480.tcl
