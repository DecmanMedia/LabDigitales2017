...
HD_PWD='C:/Users/Diego/LabDigitales2017/Lab6_PartePrevia_VGA/Lab6_PartePrevia_VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_pattern_previo_640x480.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_pattern_previo_640x480.tcl -notrace
