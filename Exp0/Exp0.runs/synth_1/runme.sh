...
HD_PWD='C:/Users/Diego/LabDigitales2017/Exp0/Exp0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ejercicio_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ejercicio_1.tcl
