...
HD_PWD='C:/GitHub/LabDigitales2017/project_example/project_example.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ejemplo_sensor_de_temperatura.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ejemplo_sensor_de_temperatura.tcl -notrace
