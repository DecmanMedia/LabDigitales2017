...
HD_PWD='C:/GitHub/LabDigitales2017/project_example/project_example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ejemplo_sensor_de_temperatura.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ejemplo_sensor_de_temperatura.tcl
