...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { dos_bit[0] }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { dos_bit[1] }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
...
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { pt }]; #IO_L19N_T3_A21_VREF_15 Sch=dp
