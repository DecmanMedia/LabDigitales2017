...
HD_PWD='C:/Users/Diego/LabDigitales2017/Lab_3/Lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dosbit_to_name.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dosbit_to_name.tcl -notrace
