...
HD_PWD='C:/Users/Diego/LabDigitales2017/Lab_3/Lab_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dosbit_to_name.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dosbit_to_name.tcl
