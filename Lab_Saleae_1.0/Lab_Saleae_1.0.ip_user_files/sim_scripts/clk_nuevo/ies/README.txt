...
#
# Generated by export_simulation on Tue May 30 16:48:54 -0400 2017
#
################################################################################
...
switch to the './clk_nuevo.sh' script.

./clk_nuevo.sh -reset_run
...
./clk_nuevo.sh -noclean_files

For more information on the script, please type './clk_nuevo.sh -help'.
