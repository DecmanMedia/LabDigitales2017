...
HD_PWD='C:/Users/Diego/LabDigitales2017/Lab_Saleae_1.0/Lab_Saleae_1.0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Boton_LED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Boton_LED.tcl
