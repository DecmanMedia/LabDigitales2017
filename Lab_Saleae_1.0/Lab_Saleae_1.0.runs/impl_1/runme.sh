...
HD_PWD='C:/Users/Diego/LabDigitales2017/Lab_Saleae_1.0/Lab_Saleae_1.0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Boton_LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Boton_LED.tcl -notrace
