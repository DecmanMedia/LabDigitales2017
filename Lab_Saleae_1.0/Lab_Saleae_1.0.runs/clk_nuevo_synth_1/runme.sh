...
HD_PWD='C:/Users/Diego/LabDigitales2017/Lab_Saleae_1.0/Lab_Saleae_1.0.runs/clk_nuevo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_nuevo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_nuevo.tcl
